...
### **3D:**
  ```regex
  \b(?<=\b[12]\d{3}\b).*\b(sbs|half[\s.-]ou|half[\s.-]sbs|BluRay3D|BD3D)\b
  ```
<details>
...
### **Anime Raws:**
  ```regex
  \b(Asuka|Beatrice|Daddy|Fumi|Iriza|Kawaiika|Koi|Lilith|LowPower|Nanako|NC|neko|Ohys|Pandoratv|Scryous|Seicher|Shiniori)[\s._-]?(Raws)\b|\b(Moozzi2|Raws-Maji|ReinForce)\b|\[km\]|-km\b
  ```
<details>
